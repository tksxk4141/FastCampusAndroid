...
import com.example.aop_part4_chapter05.databinding.ActivityRepositoryBinding
import com.example.aop_part4_chapter05.extensions.loadCenterInside
...
class RepositoryActivity : AppCompatActivity(), CoroutineScope {
    ...
    private suspend fun loadRepository(repositoryOwner: String, repositoryName: String) = withContext(coroutineContext){
