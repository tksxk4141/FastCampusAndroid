...
import com.example.aop_part5_chapter07.databinding.ItemFeaturedMovieBinding
import com.example.aop_part5_chapter07.databinding.ItemMovieBinding
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when {
            ...
            holder is FeaturedMovieItemViewHolder && itemValue is FeaturedMovie -> {
                Log.e("review", itemValue.toString())
                holder.bind(itemValue)
            }
