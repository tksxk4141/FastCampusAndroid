...
import com.example.aop_part5_chapter04.DBKey.Companion.DB_CHAT
...
class ChatRoomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val chatRoom = intent.getStringExtra("chatKey")
        if (chatRoom != null) {
            chatDB  = Firebase.database.reference.child(DB_CHAT).child(chatRoom)
        }
