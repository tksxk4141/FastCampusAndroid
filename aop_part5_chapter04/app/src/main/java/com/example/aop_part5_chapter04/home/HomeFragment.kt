...
import com.example.aop_part5_chapter04.chatlist.ChatListItem
import com.example.aop_part5_chapter04.databinding.FragmentHomeBinding
            ...
            if(auth.currentUser != null){
                if(auth.currentUser!!.uid != articleModel.sellerId){
                    val chatRoom = ChatListItem(
                        ...
                        key = articleModel.sellerId+auth.currentUser
                    )
